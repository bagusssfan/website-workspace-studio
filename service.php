    ...
    <main class="main">
        ...
        <section id="pricing" class="pricing section">
            ...
            <div class="container section-title" data-aos="fade-up">
                ...
                <p>Jelajahi berbagai pilihan paket fotografi yang kami tawarkan untuk memenuhi kebutuhan Anda. </p>
                <p>Setiap paket dirancang untuk menangkap momen berharga Anda dengan kualitas terbaik, sesuai dengan budget dan preferensi Anda.</p>
                ...
                <div class="row g-4 g-lg-0">
                    ...
                    <div class="col-lg-4" data-aos="zoom-in" data-aos-delay="100">
                        <div class="pricing-item">
                            ...
                            <ul>
                                <li><i class="bi bi-check"></i> <span>Foto 1 role </span></li>
                                <li><i class="bi bi-check"></i> <span>video</span></li>
                   
                                <li class="na"><i class="bi bi-x"></i> <span>teaser</span></li>
                                <li class="na"><i class="bi bi-x"></i> <span>album foto</span></li>
                            </ul>
                    ...
                    <div class="col-lg-4 featured" data-aos="zoom-in" data-aos-delay="200">
                        <div class="pricing-item">
                            <h3>Paket standar</h3>
                            <h4><sup>Rp</sup>4.500.000,-</h4>
                            <ul>
                                <li><i class="bi bi-check"></i> <span>Foto 1 role </span></li>
                                <li><i class="bi bi-check"></i> <span>video</span></li>
                   
                                <li><i class="bi bi-check"></i> <span>teaser</span></li>
                                <li class="na"><i class="bi bi-x"></i> <span>album foto</span></li>
                            </ul>
                            <div class="text-center"><a href="#" class="buy-btn">Buy Now</a></div>
                        </div>
                    ...
                    <div class="col-lg-4" data-aos="zoom-in" data-aos-delay="100">
                        <div class="pricing-item">
                            ...
                            <ul>
                                ...
                                <li><i class="bi bi-check"></i> <span>teaser</span></li>
                                <li><i class="bi bi-check"></i> <span>album foto</span></li>
                            </ul>
                            <div class="text-center"><a href="#" class="buy-btn">Buy Now</a></div>
                        </div>
                    </div><!-- End Pricing Item -->
    ...
    buyButtons.forEach(button => {
      button.addEventListener('click', function (event) {
        ...
        if (!isLoggedIn) {
          ...
          // Aksi jika user sudah login, misalnya redirect ke halaman pembelian
