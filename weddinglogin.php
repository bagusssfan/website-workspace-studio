  ...
  <div class="container position-relative">
    ...
    <nav class="breadcrumbs">
      <ol>
        ...
        <li class="current">Foto Wedding</li>
      </ol>
    </nav>
  </div>
</div><!-- End Page Title -->
    ...
    <div class="row gy-4">
      ...
      <div class="col-lg-8">
        <div class="portfolio-details-slider swiper init-swiper">
          ...
          <div class="swiper-wrapper align-items-center">
            ...
            $query_wisuda = mysqli_query($koneksi, "SELECT * FROM tb_barang WHERE kategori='wedding'");
      ...
      <div class="col-lg-4">
        ...
        <div class="portfolio-description" data-aos="fade-up" data-aos-delay="300">
          <h2> Abadikan momen pernikahan Anda dengan sentuhan kreativitas yang segar. Fotografi kami menghadirkan gaya inovatif dan unik untuk hari istimewa Anda.</h2>
          <p>
          Setiap momen pernikahan Anda akan ditangkap dengan indah dalam foto-foto yang memukau. Nikmati hasil akhir yang menakjubkan dari hari bahagia Anda. Dari persiapan hingga resepsi, kami menangkap setiap momen berharga dari hari pernikahan Anda dengan gaya yang elegan dan penuh makna.
          </p>
        </div>
      </div>
