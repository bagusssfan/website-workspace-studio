        ...
        <section id="portfolio" class="portfolio section light-background">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-fotoanak">
                ...
                <div class="portfolio-info">
                    <p><?= $data['kategori'] ?></p>
                    <a href="fotoanak.php" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
                </div>
            </div>
            <?php endwhile; ?>
            <?php
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-fotodigital">
                ...
                <div class="portfolio-info">
                    ...
                    <p><?= $data['kategori'] ?></p>
                    <a href="fotodigital.php" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
                </div>
            </div>
            <?php endwhile; ?>
            <?php
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-orcestra">
                ...
                <div class="portfolio-info">
                    <p><?= $data['kategori'] ?></p>
                    <a href="orcestra.php" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
                </div>
            </div>
            <?php endwhile; ?>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-prewedding">
                ...
                <div class="portfolio-info">
                    ...
                    <p><?= $data['kategori'] ?></p>
                    <a href="prewedding.php" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
                </div>
            </div>
            <?php endwhile; ?>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-wedding">
                ...
                <div class="portfolio-info">
                    ...
                    <p><?= $data['kategori'] ?></p>
                    <a href="wedding.php" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
                </div>
            </div>
            <?php endwhile; ?>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-tunangan">
                ...
                <div class="portfolio-info">
                    <p><?= $data['kategori'] ?></p>
                    <a href="tunangan.php" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
                </div>
            </div>
            <?php endwhile; ?>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-wisuda">
                ...
                <div class="portfolio-info">
                    ...
                    <p><?= $data['kategori'] ?></p>
                    <a href="wisuda.php" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
                </div>
            </div>
            <?php endwhile; ?>
