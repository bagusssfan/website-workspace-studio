  ...
  <div class="container position-relative">
    ...
    <nav class="breadcrumbs">
      <ol>
        ...
        <li class="current">Foto Digital</li>
      </ol>
    </nav>
  </div>
</div><!-- End Page Title -->
    ...
    <div class="row gy-4">
      ...
      <div class="col-lg-8">
        <div class="portfolio-details-slider swiper init-swiper">
          ...
          <div class="swiper-wrapper align-items-center">
            ...
            $query_wisuda = mysqli_query($koneksi, "SELECT * FROM tb_barang WHERE kategori='fotodigital'");
      ...
      <div class="col-lg-4">
        ...
        <div class="portfolio-description" data-aos="fade-up" data-aos-delay="300">
          <h2> Abadikan setiap momen dengan kejernihan dan detail luar biasa. Fotografi digital kami membawa kenangan Anda hidup!</h2>
          <p>
          Foto digital berkualitas tinggi untuk setiap momen berharga. Dari potret keluarga hingga acara khusus, kami siap membantu Anda. Momen indah tidak akan pernah pudar dengan fotografi digital kami. Simpan kenangan Anda dalam kualitas terbaik.
          </p>
        </div>
      </div>
