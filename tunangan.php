  ...
  <div class="container position-relative">
    ...
    <nav class="breadcrumbs">
      <ol>
        ...
        <li class="current">Foto Tunangan</li>
      </ol>
    </nav>
  </div>
</div><!-- End Page Title -->
    ...
    <div class="row gy-4">
      ...
      <div class="col-lg-8">
        <div class="portfolio-details-slider swiper init-swiper">
          ...
          <div class="swiper-wrapper align-items-center">
            ...
            $query_wisuda = mysqli_query($koneksi, "SELECT * FROM tb_barang WHERE kategori='tunangan'");
      ...
      <div class="col-lg-4">
        ...
        <div class="portfolio-description" data-aos="fade-up" data-aos-delay="300">
          <h2> Momen tunangan Anda adalah awal dari perjalanan cinta yang indah. Biarkan kami menangkap setiap detik dari hari bersejarah Anda dalam foto-foto yang abadi.</h2>
          <p>
          Dari tawa bahagia hingga momen penuh cinta, sesi foto tunangan kami akan mengabadikan keindahan hubungan Anda dalam setiap jepretan. Rayakan cinta Anda dengan sesi foto tunangan yang penuh keindahan. Abadikan momen spesial ini dengan gambar-gambar yang akan selalu Anda hargai.
          </p>
        </div>
      </div>
