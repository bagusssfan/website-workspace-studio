...
<head>
  ...
  <title>Workspace Studio | Admin</title>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <h3 class="ml-3"><?php echo $greeting; ?></h3>
    </ul>
  ...
  <aside class="main-sidebar sidebar-dark-warning elevation-4" style="background-color: #1e272e;">
    ...
    <a href="" class="brand-link">
      <span style="color: #f39c12;"> Workspace Studio</span> 
    </a>
        ...
        <?php
            if(isset($_GET['page'])) {
                ...
                switch($_GET['page']) {
                    ...
                    break;
                    case 'kelola_chat';
                    include 'kelola_pelanggan/kelola_chat.php';
                    break;
                    case 'check_chat';
                    include 'kelola_pelanggan/check_new_messages.php';
                    break;
                    //kelola barang
                    case 'barang';
                    ...
                    //kelola vendor
                    case 'vendor';
                    include 'kelola_vendor/kelola_vendor.php';
                    break;
                    case 'tambah_vendor';
                    include 'kelola_vendor/tambah.php';
                    break;
                    case 'ubah_vendor';
                    include 'kelola_vendor/ubah.php';
                    break;
                    case 'hapus_vendor';
                    include 'kelola_vendor/hapus.php';
                    break;
                    case 'detail_vendor';
                    include 'kelola_vendor/detail_vendor.php';
                    break;
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2024</strong> <span>Workspace | Repost by <a href='https://www.instagram.com/workspace.studio?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==' title='Workspace.com' target='_blank'>Workspace.com</a>
    </span>
  </footer>
