  ...
  <div class="container position-relative">
    ...
    <nav class="breadcrumbs">
      <ol>
        ...
        <li class="current">Foto Orcestra</li>
      </ol>
    </nav>
  </div>
</div><!-- End Page Title -->
    ...
    <div class="row gy-4">
      ...
      <div class="col-lg-8">
        <div class="portfolio-details-slider swiper init-swiper">
          ...
          <div class="swiper-wrapper align-items-center">
            ...
            $query_wisuda = mysqli_query($koneksi, "SELECT * FROM tb_barang WHERE kategori='orcestra'");
      ...
      <div class="col-lg-4">
        ...
        <div class="portfolio-description" data-aos="fade-up" data-aos-delay="300">
          <h2> Abadikan momen megah dari setiap konser orkestra dengan detail yang tak terlupakan. Fotografer profesional kami siap menangkap keindahan setiap nada dan ekspresi.</h2>
          <p>
          Setiap jepretan adalah simfoni visual. Biarkan kami mengabadikan konser orkestra Anda dalam gambar yang penuh dengan keindahan dan detail.
          </p>
        </div>
      </div>
